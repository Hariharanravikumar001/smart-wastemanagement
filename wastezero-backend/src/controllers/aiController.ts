...
export const detectWaste = async (req: Request, res: Response): Promise<void> => {
  try {
...
export const chatbotResponse = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (
      msgLower.includes('hello') || msgLower.includes('hi') || msgLower.includes('hey') || 
      msgLower.includes('வணக்கம்') || msgLower.includes('உதவி') || 
      msgLower.includes('नमस्ते') || msgLower.includes('मदद') || msgLower.includes('help')
    ) {
      intent = 'GREETING';
    } else if (
      msgLower.includes('pickup') || msgLower.includes('schedule') || msgLower.includes('collect') || 
      msgLower.includes('பிக்கப்') || msgLower.includes('திட்டமிடு') || 
      msgLower.includes('पिकअप') || msgLower.includes('शेड्यूल')
    ) {
      intent = 'PICKUP';
    } else if (
      msgLower.includes('reward') || msgLower.includes('point') || msgLower.includes('badge') || msgLower.includes('coupon') || 
      ...
      msgLower.includes('volunteer') || msgLower.includes('ngo') || msgLower.includes('project') || msgLower.includes('opportunity') || 
      msgLower.includes('தன்னார்வ') || msgLower.includes('வாய்ப்பு') || 
      msgLower.includes('स्वयंसेवक') || msgLower.includes('अवसर')
    ) {
      intent = 'VOLUNTEER';
    } else if (
      msgLower.includes('segregate') || msgLower.includes('sort') || msgLower.includes('separate') || msgLower.includes('organic') || msgLower.includes('plastic') ||
      msgLower.includes('பிரி') || msgLower.includes('குப்பை') || 
      msgLower.includes('अलग') || msgLower.includes('कचरा')
    ) {
      intent = 'SEGREGATE';
    } else if (
      msgLower.includes('ai') || msgLower.includes('scan') || msgLower.includes('detect') || msgLower.includes('camera') || msgLower.includes('image') ||
